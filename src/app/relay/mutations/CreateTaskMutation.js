...
class CreateTaskMutation extends Relay.Mutation {
  ...
  getVariables() {
    const { label, type, description, jsonoptions, annotated_type, annotated_dbid } = this.props;
    return { label, type, description, jsonoptions, annotated_type, annotated_id: annotated_dbid };
  }
