...
export const createPlaceInstance =
  (name, { fragment }, content, annotated_id, parentID, callback) => {
    ...
    return commitMutation(environment, {
      mutation: graphql`
        mutation MediaTimelineMutationsCreatePlaceInstanceMutation($input: CreateDynamicInput!) {
...
export const createPlace = (name, payload, annotated_id, parentID, callback) => {
  ...
  return commitMutation(environment, {
    mutation: graphql`
      mutation MediaTimelineMutationsCreatePlaceMutation($input: CreateDynamicInput!) {
        createDynamic(input: $input) {
          dynamicEdge {
            node {
              id
