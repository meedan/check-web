  ...
  render() {
    return (
      <div className="media-checklist">
        <aside>
          <h3><FormattedMessage id="mediaChecklist.heading" defaultMessage="Verification checklist" /></h3>
          <p><FormattedMessage id="mediaChecklist.instructions" defaultMessage="Here are some common steps in collaborative media verification. Complete as many tasks as you can so we have a complete, transparent record of our investigation." /></p>
        </aside>
        <ul>
          <li>
