      ...
      <ErrorBoundary component="ArticlesDashboard">
        <QueryRenderer
          ...
          render={({ error, props }) => {
            ...
            return <MediasLoading size="large" text={<FormattedMessage defaultMessage="Fetching real-time data, please wait…" description="Loading message of the dashboard page." id="articlesDashboard.loading" />} theme="white" variant="page" />;
          }}
          variables={{
