...
const MediaAndArticleTagListComponent = ({
  maxTags,
  onClickTag,
  options: teamTags,
  readOnly,
    ...
    <ButtonMain
      ...
      label={
        <FormattedMessage
          ...
          id="MediaAndArticleTagListComponent.create"
        />
      }
      size="default"
      theme="info"
            ...
            <MultiSelector
              ...
              notFoundLabel={
                <FormattedMessage
                  ...
                  id="MediaAndArticleTagListComponent.notFound"
                />
              }
              options={options}
              selected={selected}
              submitLabel={
                <FormattedMessage
                  ...
                  id="MediaAndArticleTagListComponent.submit"
                />
              }
        ...
        tags.length === 0 && (
          <em className={cx('typography-body2', styles['empty-list'])} id="empty-list" >
            <FormattedMessage
              ...
              id="MediaAndArticleTagListComponent.empty"
            />
          </em>
        )
      }
        ...
        <Tooltip
          ...
          title={
            <FormattedMessage
              ...
              id="MediaAndArticleTagListComponent.tooltipManage"
            />
          }
        >
          <div>
...
MediaAndArticleTagListComponent.defaultProps = {
  readOnly: false,
  maxTags: Infinity,
  onClickTag: null,
  options: null,
...
MediaAndArticleTagListComponent.propTypes = {
...
const MediaAndArticleTagList = (parentProps) => {
  ...
  return (<QueryRenderer
    ...
    query={graphql`
      query MediaAndArticleTagListQuery($teamSlug: String!, $pageSize: Int!, $keyword: String) {
        team(slug: $teamSlug) {
    ...
    render={({ error, props }) => {
      if (!error && props) {
        return (
          <MediaAndArticleTagListComponent
            {...parentProps}
...
export default MediaAndArticleTagList;
