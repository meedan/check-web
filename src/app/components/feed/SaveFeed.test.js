...
describe('<SaveFeed />', () => {
  ...
  // FIXME CV2-3803
  it.skip('should render license checkboxes when discoverable', () => {
  ...
  // FIXME CV2-3803
  it.skip('should render license checkboxes and no error when discoverable and licenses selected', () => {
