...
const descriptions = {
  ...
  smooch_message_smooch_bot_no_action: <FormattedMessage id="smoochBot.descriptionNoAction" defaultMessage="This message will be sent to users if after a conversation is initiated, they do not select options either receive a resource or submit content to verify. This message will also be sent to users who submitted content without waiting for the query prompt." />,
