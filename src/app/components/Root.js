...
import MemebusterComponent from './memebuster/MemebusterComponent';
          ...
          <Provider store={store}>
            <Router history={this.state.history} onUpdate={Root.logPageView}>
              <Route path="/" component={App}>
                ...
                <Route path=":team/project/:projectId/media/:mediaId/memebuster" component={MemebusterComponent} />
