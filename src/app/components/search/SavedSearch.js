          ...
          return (
            <div className="saved-search search-results-wrapper">
              <Search
                ...
                listSubtitle={<FormattedMessage defaultMessage="Custom Tipline List" description="Displayed on top of the custom list title on the search results page." id="savedSearch.subtitle" />}
