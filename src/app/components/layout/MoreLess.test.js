...
describe('<MoreLess />', () => {
  ...
  it('should render children text inside more-less-content area', () => {
    ...
    />);
    expect(wrapper.find('.more-less-content span.Linkify').text()).toMatch('We are a technology non-profit that builds software and initiatives to strengthen global journalism');
