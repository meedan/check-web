...
const heapAnalytics = (config) => {
  return config.heapAppId && NODE_ENV === 'production' ?
...
const uptimeMonitoring = (config) => {
  return config.uptimeId && NODE_ENV === 'production' ?
  ...
  return `
      ...
      <html>
        <head>
          ...
          <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500|Roboto+Mono" rel="stylesheet" type="text/css">
