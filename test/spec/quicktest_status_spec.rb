...
shared_examples 'quicktest_status' do
  ...
  it "should change a media status via the dropdown menu" do
    ...
    element.click
    element = @driver.find_element(:css, ".media-status__menu-item--translated")
    element.click
    sleep 3
    # Uncomment after we implement translation status messages on the log
    # element = @driver.find_element(:css, '.annotation__status--translated')
