...
describe('<QuoteMediaCard />', () => {
  it('renders arabic quotes in RTL form', () => {
    const quote = mountWithIntl(<QuoteMediaCard quote="الدخول ممنوع" languageCode="ar" />);
  ...
  it('renders english quotes in LTR form', () => {
    const quote = mountWithIntl(<QuoteMediaCard quote="Access Denied" languageCode="en" />);
