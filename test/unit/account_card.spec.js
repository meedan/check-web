...
describe('<AccountCard />', () => {
  ...
  const account = { id: '123', provider: 'facebook', url: 'http://www.facebook.com/foobar', embed: { name: 'Foo Bar', username: 'foobar', url: 'http://www.facebook.com/foobar', picture: 'http://placehold.it/200x200', description: 'The Story of Foo Bar' } };
