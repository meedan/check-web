/* eslint-disable */
import { intersectIntervals, getTimelineData } from '../../src/app/components/media/MediaTimelineUtils';

describe('Media Timeline Utils', () => {
  it('intersect separate intervals', () => {
    expect(intersectIntervals([[0, 10], [20, 30], [40, 50]]))
      .toEqual([[0, 10], [20, 30], [40, 50]]);
  });

  it('intersect overlapping intervals', () => {
    expect(intersectIntervals([[0, 15], [10, 30]]))
      .toEqual([[0, 30]]);
  });
  ...
  it('convert clips', () => {
    expect(getTimelineData({
      "media": {
        "comments": {
          "__dataID__": "client:-7090457795_first(10000),annotation_type(comment)",
          "edges": []
        },
        "clips": {
        ...
        "geolocations": {
          "__dataID__": "client:-70904577910_first(10000),annotation_type(geolocation)",
          "edges": []
        }
      },
      "currentUser": {
        ...
        "dbid": 4,
        "name": "Laurian",
        "token": "eyJwcm92aWRlciI6ImNoZWNrZGVzayIsImlkIjoiIiwidG9rZW4iOiJxVktU++ncFB5RCIsInNlY3JldCI6IjFoV2h4enJwIn0=++n",
        "email": "laurian@meedan.com",
        "is_admin": false,
        "accepted_terms": true,
        "last_accepted_terms_at": "2020-05-14 16:49:31 UTC",
        "login": "laurian",
        "permissions": "{\"read User\":true,\"update User\":true,\"destroy User\":true,\"create Source\":true,\"create TeamUser\":false,\"create Team\":true,\"create Project\":true}",
        "profile_image": "http://localhost:3000/images/user.png",
        "settings": {},
        "source_id": 4,
        "team_ids": [
        ...
        "user_teams": "{\"workspace1\":{\"id\":2,\"name\":\"workspace1\",\"role\":\"owner\",\"status\":\"member\"}}",
        "current_project": {
        ...
        "teams": "{\"workspace1\":{\"id\":2,\"name\":\"workspace1\",\"role\":\"owner\",\"status\":\"member\"}}"
      }
    }))
      .toEqual({
        "project": {
            ...
            "instances": [
              {
                ...
                "url": "http://localhost/#t=10820.223817415732,10850.223817415732&id=RHluYW1pYy8yNzc%3D%0A"
              }
            ],
            "node": {
              "__dataID__": "RHluYW1pYy8yNzc=\n",
            ...
            "instances": [
              {
                ...
                "url": "http://localhost/#t=7230.336476123596,7260.336476123596&id=RHluYW1pYy8yNzY%3D%0A"
              },
              {
                "id": "RHluYW1pYy8yNzU=\n",
                "start_seconds": 3640.449134831461,
                "end_seconds": 3670.449134831461,
                "url": "http://localhost/#t=3640.449134831461,3670.449134831461&id=RHluYW1pYy8yNzU%3D%0A"
              }
            ],
            "node": {
              "__dataID__": "RHluYW1pYy8yNzY=\n",
